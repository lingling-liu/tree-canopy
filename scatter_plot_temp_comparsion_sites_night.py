...
ax[i].plot([lower,upper], [lower,upper], color='red',linestyle='--')
...
r'$R^2=%.3f$' % (r_value**2,),
r'$P=%.3f$' % (p_value,)))
ax[i].text(22, 17, textstr, fontsize=14, verticalalignment='top')
...
plt.savefig("scatter_plot_ground_night_modelled_sites.png",dpi =300)