pro tree_canopy_reclassify_NASA

  ; read tree canopy percentages
  data = READ_TIFF("/largedisk_a/tree_canopy/original_data/30m/tcma_lc_treecanopy_30m.tif",geotiff = geotiff_tree)
  ...
  data_tree1 =  bytarr(ns,nl)
  readu,lun,data_tree1
  free_lun, lun
  ...
  path = "/largedisk_a/tree_canopy/original_data/NLCD_2016_Land_Cover_new_addingtree_NASA.tif"
