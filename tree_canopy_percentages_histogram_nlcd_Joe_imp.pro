pro tree_canopy_percentages_histogram_NLCD_joe_imp

  ; read tree canopy percentages
  data_tree = READ_TIFF("/largedisk_a/tree_canopy/original_data/30m/tcma_lc_finalv1_2015_30m.tif",geotiff = geotiff_tree)
  ...
  infile = "/largedisk_a/tree_canopy/original_data/NLCD_2016_Land_Cover_clip_tcma_final.tif"
  ...
  for i=0,n_elements(nlcd_classes)-1 do begin
    ...
    if count eq 1 then begin
      ...
      if count1 gt 100 then begin
        q++
;        title1 = nlcd_name[index] +"_Joe_imp"
